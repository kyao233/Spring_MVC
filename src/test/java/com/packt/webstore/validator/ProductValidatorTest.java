...
public class ProductValidatorTest {
	...
	@Test
	public void product_without_unit_price_should_be_invalid() {
		//Arrange
		...
		Assert.assertTrue(bindException.getLocalizedMessage().contains("Allowed categories: Computer, Phone, Light, Tablet"));
	}
